...
public class Variant1Test {
    ...
    public void integerTest(int p1, int[] expected) {
        assertEquals(new Variant1().integerTask(p1), expected);
    }
    ...
    public void booleanTest(int p1, int p2, int p3, boolean p4) {
        assertEquals(new Variant1().booleanTask(p1, p2, p3), p4);
    }
    ...
    public void switchTest(int p1, int p2, double p3) {
        assertEquals(new Variant1().switchTask(p1, p2), p3, EPS); //method changed
    }
    ...
    public void minMaxTest(int[] array, int[] expected) {
        assertEquals(new Variant1().minMaxTask(array),expected);
    }
    ...
    public void arrayTest(int n, int a, int b, int[] expected) {
        assertEquals(new Variant1().arrayTask(n,a,b), expected);
    }
    ...
    public void twoDimensionArrayTest(int[] array, int m, int q, int[][] output) {
        assertEquals(new Variant1().twoDimensionArrayTask(array,m, q), output);
    }
